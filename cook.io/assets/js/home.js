...
$searchBtn.addEventListener("click", function () {
    if ($searchField.value) window.location = `/recipes.html?q=${$searchField}`;
});
...
const /** {NodeEList} */ $tabBtns = document.querySelectorAll("[data-tab-btn]");
const /** {NodeEList} */ $tabPanels = document.querySelectorAll("[data-tab-panel]");
            ...
            $card.innerHTML = `
                        ...
                        <div class="card-body">
                                <h3 class="title-small">
                                    <a href="./detail.html?recipe=${recipeId}" class="card-link">${title ?? "Untitle"}
                                    </a>
                                </h3>
...
for (const [index, $section] of $sliderSections.entries()) {
    $section.innerHTML = `
    <div class="container">
    ...
    const /**{NodeElement} */ $sliderWrapper = $section.querySelector("[data-slider-wrapper]");
